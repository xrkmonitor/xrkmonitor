...
#ifndef _SV_SHARED_HASH_H_20170304_
#define _SV_SHARED_HASH_H_20170304_ 1
...
typedef struct
{
	...
	uint32_t dwWriteProcessId; // 写进程 id [一写多读模式使用] --- 废弃，无用，一般后台进程会 fork 
	uint32_t dwLastUseTimeSec; // bHashUseFlag 设置时间
...
#define SHARED_HASH_ACCESS_CHECK_FAILED do { MtReport_Attr_Spec(90, 1); \
