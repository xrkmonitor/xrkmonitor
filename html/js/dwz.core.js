...
var DWZ = {
	...
	statusCode: {success:0, ok:200, error:300, timeout:301},
	ui:{sbar:true},
	frag:{}, //page fragment
	_msg:{}, //alert message
	_set:{
			...
			$.ajax({
				...
				success: function(response){
					...
					if (json.statusCode==DWZ.statusCode.error){
						...
						// ysy -- modify
						else if(json.msg && alertMsg) alertMsg.error(json.msg);
					} else {
